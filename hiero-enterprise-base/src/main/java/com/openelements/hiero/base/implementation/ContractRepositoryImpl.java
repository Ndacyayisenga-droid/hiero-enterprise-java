...
public class ContractRepositoryImpl implements ContractRepository {
    ...
    @NonNull
    @Override
    public Page<Contract> findBySolidityAddress(@NonNull final String solidityAddress) throws HieroException {
        return mirrorNodeClient.queryContractsBySolidityAddress(solidityAddress);
    }
