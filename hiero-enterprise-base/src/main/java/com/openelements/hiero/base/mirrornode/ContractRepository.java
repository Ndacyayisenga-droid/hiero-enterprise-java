...
public interface ContractRepository {
    ...
    /**
     * Return contracts by Solidity address.
     *
     * @param solidityAddress the Solidity address of the contract
     * @return first page of contracts
     * @throws HieroException if the search fails
     */
    @NonNull
    Page<Contract> findBySolidityAddress(@NonNull String solidityAddress) throws HieroException;
