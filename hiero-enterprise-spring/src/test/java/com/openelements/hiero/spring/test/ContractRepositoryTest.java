...
public class ContractRepositoryTest {
    ...
    void testNullParam() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> contractRepository.findBySolidityAddress(null));
    ...
    @Test
    void testFindBySolidityAddressWithNonExistentAddress() throws HieroException {
        // given
        final String nonExistentSolidityAddress = "0x0000000000000000000000000000000000000000";

        // when
        final Page<Contract> result = contractRepository.findBySolidityAddress(nonExistentSolidityAddress);
